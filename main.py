...
API_ID = int(os.environ.get("API_ID", 27049009))
API_HASH = os.environ.get("API_HASH", "fdbb025703492ee68251614682e2b4d3")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7862887428:AAFEGw9-IMSaXqJNht-0uTEo47cEsw1YMJs")
